...
function ecCheckCookie() {
  ...
  if (bgImageMode != "") {
    ...
    $("#bg-switcher-css").attr(
      "href",
      "assets/demo-3/css/backgrounds/" + bgID + ".css"
    );
  }
    ...
    if (themeColor != "") {
      ...
      if (themeColor != "01") {
        $("link[href='assets/demo-3/css/responsive.css']").before(
          '<link rel="stylesheet" href="assets/demo-3/css/skin-' +
            themeColor +
            '.css" rel="stylesheet">'
        );
      }
...
(function ($) {
  ...
  (function () {
    ...
    $(".ec-side-cart-overlay, .ec-mobile-menu-overlay").on(
      "click",
      function (e) {
  ...
  function get_prev_slick_img() {
    // For prev img
    var prev_slick_img = $(".ec-slider .slick-current")
      .prev()
      .find("img.main_banner_arrow_img")
      .attr("src");
    $(".ec-slider .prev-slick-img img").attr("src", prev_slick_img);
    $(".ec-slider .prev-slick-img").css(
      "background-image",
      "url(" + prev_slick_img + ")"
    );
    // For next img
    var prev_next_slick_img = $(".ec-slider .slick-current")
      .next()
      .find("img.main_banner_arrow_img")
      .attr("src");
    $(".ec-slider .next-slick-img img").attr("src", prev_next_slick_img);
    $(".ec-slider .next-slick-img").css(
      "background-image",
  ...
  function get_next_slick_img() {
    // For next img
    var next_slick_img = $(".ec-slider .slick-current")
      .next("")
      .find("img.main_banner_arrow_img")
      .attr("src");
    ...
    // For prev img
    var next_prev_slick_img = $(".ec-slider .slick-current")
      .prev("")
      .find("img.main_banner_arrow_img")
      .attr("src");
